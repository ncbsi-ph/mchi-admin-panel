...
import { addSpecialServiceImg, uploadImage } from '../../../api';
import { handleError } from '../../../helpers';
import ServiceImgFormModal from '../ServiceImgFormModal';

const AddSpecialServiceImg = () => {
  ...
  const addEyeImgMutation = useMutation({
    mutationFn: async () => {
      try {
        ...
        const response = await addSpecialServiceImg(payload, token);
...
export default AddSpecialServiceImg;
